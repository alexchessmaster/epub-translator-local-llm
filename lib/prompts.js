...
const DEFAULT_PROMPT = {
  ...
  system:
    'You are a professional literary translator rendering English prose into natural, idiomatic Persian (Farsi).',
  rules: [
    ...
    'Transliterate proper nouns and character names to Persian and keep them consistent with the glossary.',
    'Use Persian digits wherever the source has digits.',
