  ...
  _launch(config, controller) {
    ...
    (async () => {
      try {
        ...
        Object.assign(this.job, {
          state: 'done',
          // Whole-book progress: 100% means the entire book is translated. A
          // partial-range run finishes at its honest book-level percent.
          percent: result.targetWords ? (100 * (result.doneWords || 0)) / result.targetWords : 100,
